...
public class TunnelBoringMachine {}//extends CartBaseContainer implements ILinkableCart {
    ...
    public TunnelBoringMachine(World world) {
        this(world, 0, 0, 0, EnumFacing.SOUTH);
    }

    public TunnelBoringMachine(World world, double x, double y, double z) {
        this(world, x, y, z, EnumFacing.SOUTH);
    }

    public TunnelBoringMachine(World world, double x, double y, double z, EnumFacing f) {
        super(world, x, y, z);
        setFacing(f);
    }
